    ...
    if(subRoute=='am_summary'){
      vars = {"formSelect":["64", "68", "81"],
              "selectedFields":[
               ...
               {"id":"55.2",
                 "label":"What are your plans at Maker Faire? Check all that apply: [MF_E, SP_SU]",
                 "choices":"Promoting a product or service [Commercial Maker]","type":"checkbox","$$hashKey":"uiGrid-0131"},
               {"id":"55.3","label":"What are your plans at Maker Faire? Check all that apply: [MF_E, SP_SU]","choices":"Launching a product or service","type":"checkbox",
                 "$$hashKey":"uiGrid-0133"},
               {"id":"55.4","label":"What are your plans at Maker Faire? Check all that apply: [MF_E, SP_SU]",
                 "choices":"Active Networking (collecting names, signatures, etc)","type":"checkbox","$$hashKey":"uiGrid-0135"},
               {"id":"55.5","label":"What are your plans at Maker Faire? Check all that apply: [MF_E, SP_SU]","choices":"Launching a crowdfunding campaign",
                 "type":"checkbox","$$hashKey":"uiGrid-0137"},
