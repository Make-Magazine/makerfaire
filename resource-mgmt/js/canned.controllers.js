  ...
  if($routeParams){
    ...
    if(subRoute=='zoho'){
      vars = {"formSelect":[],
              ...
              "useFormSC": true,
              "selectedFields":[
                {"id":16,"label":"EXHIBIT SUMMARY","choices":"","type":"textarea","inputs":""},
                {"id":376,"label":"CM","choices":"Yes","type":"radio"},
                {"id":83,"label":"FIRE","choices":"Yes","type":"radio"},
                {"id":83,"label":"FIRE","choices":"No","type":"radio"},
                ...
                {"id":98,"label":"EMAIL","choices":"","type":"email","inputs":""},
                {"id":99,"label":"PHONE","choices":"","type":"phone","inputs":""},
                {"id":151,"label":"EXHIBIT","choices":"","type":"text","inputs":""},
                {"id":293,"label":"WRIST","choices":"Yes","type":"radio"},
                {"id":293,"label":"WRIST","choices":"No","type":"radio"},
                {"id":303,"label":"Status","choices":"Proposed","type":"radio"},
                {"id":303,"label":"Status","choices":"Accepted","type":"radio"},
                {"id":303,"label":"Status","choices":"Rejected","type":"radio"},
                {"id":303,"label":"Status","choices":"Wait List","type":"radio"},
                {"id":303,"label":"Status","choices":"Cancelled","type":"radio"},
                {"id":317,"label":"WASTE","choices":"Yes","type":"radio"},
                {"id":317,"label":"Will your exhibit produce any waste?","choices":"No","type":"radio"}
              ],
              "rmtData":{
                "resource":[
                  {"id":"all","value":"ALL RESOURCES","checked":true},
                  {"id":"2","value":"TABLE","checked":true},
                  {"id":"3","value":"CHAIR","checked":true},
                  {"id":"9","value":"ELEC","checked":true},
                  {"id":"15","value":"H2O","checked":true},
                  {"id":"18","value":"FENCE","checked":true},
                  {"id":"19","value":"BARR","checked":true},
                  {"id":"45","value":"UMB","checked":true},
                  {"id":"47","value":"GRIND","checked":true}],
                "attribute":[
