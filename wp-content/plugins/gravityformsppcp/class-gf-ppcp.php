	...
	public function scripts() {
		...
		$scripts = array(
			...
			array(
				...
				'strings' => array(
					'unsupported_payment_option_message' => wp_strip_all_tags( __( 'Credit card fields are not currently supported for subscriptions and will not display on your form, but the user can still pay using the card option via the PayPal Checkout Modal.', 'gravityformsppcp' ) ),
