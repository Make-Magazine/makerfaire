<template>
	...
	>
		<div v-if="!reachedMaxFiles">
			<span>
				{{ strings.drop_files_here }} {{ strings.or }} &nbsp;
			</span>
			<span class="gpfup__select-files-container">
				<button type="button" class="gpfup__select-files gform_button_select_files" @click.prevent="onBrowse">{{ strings.select_files }}</button>
			</span>
		</div>
		<div v-else>
			<span>
