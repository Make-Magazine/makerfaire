...
if(f.length&&"1"==f.find(".epyt-pagebutton").first().data("autonext")&&c.data===b.YT.PlayerState.ENDED){c=f.find(".epyt-current-video");c.length||(c=f.find(".epyt-gallery-thumb").first());var l=c.find(" ~ .epyt-gallery-thumb").first();c=d("div.lity-wrap[data-lity-close]");l.length?c.length?(b._EPADashboard_.lb.close(),setTimeout(function(){l.trigger("click")},1E3)):l.trigger("click"):c.length?(b._EPADashboard_.lb.close(),setTimeout(function(){f.find('.epyt-pagebutton.epyt-next[data-pagetoken!=""][data-pagetoken]').first().trigger("click")},
...
[];e=null;var l=!1,m=!1,h=0,n=a.data("channel")||b._EPADashboard_.justid(a.data("src"),"channel");b._EPYT_.alreadyCheckingRealtimeLivestreams||(b._EPYT_.alreadyCheckingRealtimeLivestreams=1,b._EPADashboard_.realtimeLiveCheck(n,f),b._EPYT_.realtimeLivestreamCheckInterval=setInterval(function(){b._EPYT_.alreadyCheckingRealtimeLivestreams++;b._EPADashboard_.realtimeLiveCheck(n,f);30<=b._EPYT_.alreadyCheckingRealtimeLivestreams&&clearInterval(b._EPYT_.realtimeLivestreamCheckInterval)},3E4));if(f.length){var g=
(new Date).toISOString();f=f.filter(function(k){return"upcoming"===k.liveBroadcastContent&&!k.actualStart&&k.start<g&&180<_EPADashboard_.dateDiffInMinutes(k.start,g)||k.actualEnd?!1:!0});for(f.sort((k,p)=>k.start<p.start?-1:k.start>p.start?1:0);h<f.length;){e=f[h];if(e.actualStart&&g>e.actualStart&&null==e.actualEnd&&"live"===e.liveBroadcastContent){l=m=!0;break}h++}if(!m)for(h=0;h<f.length;){e=f[h];if(e.actualStart&&g>e.actualStart&&(null==e.actualEnd||g<e.actualEnd)){l=m=!0;break}h++}if(!m)for(h=
0;h<f.length;){e=f[h];if(e.start&&g<e.start){m=!0;break}h++}if(!m)for(h=f.length-1;0<=h;){e=f[h];if(e.start&&g>e.start){m=!0;break}h--}m&&e&&(b._EPYT_.not_live_on_channel&&(b._EPADashboard_.dateDiffInMinutes(g,e.start)>parseInt(b._EPYT_.not_live_showtime)||e.actualStart&&b._EPADashboard_.dateDiffInMinutes(g,e.actualStart)>parseInt(b._EPYT_.not_live_showtime))?b._EPADashboard_.doLiveFallback(a.get(0)):(m=a.data("src").replace("live_stream",e.id),l||b._EPADashboard_.dateDiffInMinutes(e.start,g),b._EPADashboard_.setVidSrc(a,
m)))}e||(b._EPYT_.not_live_on_channel?b._EPADashboard_.doLiveFallback(a.get(0)):b._EPADashboard_.findSwapBlock(a.get(0)).replaceWith(d('<div class="epyt-video-wrapper epyt-do-live-fallback"></div>').attr("data-channel",n)))}});d(".epyt-gallery").each(function(){var a=d(this);if(!a.data("epytevents")||!d("body").hasClass("block-editor-page")){a.data("epytevents","1");var e=d(this).find("iframe, div.__youtube_prefs_gdpr__, div.epyt-facade").first(),f="content"+e.attr("id");a.find(".lity-hide").attr("id",
f);var l=e.data("src")||e.data("facadesrc")||e.data("lbsrc")||e.attr("src");l||(l=e.data("ep-src"));var m=d(this).find(".epyt-gallery-list .epyt-gallery-thumb").first().data("videoid");"undefined"!==typeof l?(l=l.replace(m,"GALLERYVIDEOID"),a.data("ep-gallerysrc",l)):e.hasClass("__youtube_prefs_gdpr__")&&a.data("ep-gallerysrc","");var h=a.find(".epyt-gallery-list"),n=function(){try{if(h.hasClass("epyt-gallery-style-carousel")){var g=d(h.find(".epyt-gallery-thumb").get(0)).height()/2;h.find(".epyt-pagination:first-child .epyt-pagenumbers").css("top",
g+15+"px")}}catch(k){}};setTimeout(function(){n()},300);d(b).on("resize",n);a.on("click touchend",".epyt-gallery-list .epyt-gallery-thumb",function(g){if(!(b._EPYT_.lityOpen||(e=a.find("iframe, div.__youtube_prefs_gdpr__, div.epyt-facade").first(),b._EPYT_.touchmoved||d(this).hasClass("epyt-current-video")&&!a.hasClass("epyt-lb")))){a.find(".epyt-gallery-list .epyt-gallery-thumb").removeClass("epyt-current-video");d(this).addClass("epyt-current-video");g=d(this).data("videoid");a.data("currvid",g);
var k=a.data("ep-gallerysrc").replace("GALLERYVIDEOID",g);g=a.find(".epyt-pagebutton").first().data("thumbplay");"0"!==g&&0!==g&&(k=0<k.indexOf("autoplay")?k.replace("autoplay=0","autoplay=1"):k+"&autoplay=1",e.addClass("epyt-thumbplay"));if(a.hasClass("epyt-lb"))b._EPADashboard_.lb("#"+f),b._EPYT_.lityOpen=!0,k=k.replace("autoplay=1","autoplay=0"),b._EPADashboard_.loadYTAPI(),b._EPADashboard_.setVidSrc(e,k),d(".lity-close").trigger("focus");else if(0===a.find(".epyt-gallery-style-carousel").length){g=
Math.max(d("body").scrollTop(),d("html").scrollTop());var p=e.offset().top-parseInt(_EPYT_.gallery_scrolloffset);g>p?d("html, body").animate({scrollTop:p},500,function(){b._EPADashboard_.setVidSrc(e,k)}):b._EPADashboard_.setVidSrc(e,k)}else b._EPADashboard_.setVidSrc(e,k)}}).on("touchmove",function(g){b._EPYT_.touchmoved=!0}).on("touchstart",function(){b._EPYT_.touchmoved=!1}).on("keydown",".epyt-gallery-list .epyt-gallery-thumb, .epyt-pagebutton",function(g){var k=g.which;if(13===k||32===k)g.preventDefault(),
