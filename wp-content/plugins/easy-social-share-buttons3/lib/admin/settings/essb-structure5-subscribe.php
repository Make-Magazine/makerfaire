...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-15', 'essb3_oflock|posttypes', esc_html__('Post types', 'essb'), esc_html__('You can choose the post types where pop-up forms will show. Leave blank for the entire website.', 'essb'), ESSB_Plugin_Loader::supported_post_types(false, false), '', '', 'true');
