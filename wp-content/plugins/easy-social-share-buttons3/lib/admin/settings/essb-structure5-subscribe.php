...
ESSBOptionsStructureHelper::field_checkbox_list('subscribe', 'optin-11', 'essb3_ofob|posttypes', esc_html__('Appear only on selected post types', 'essb'), '', essb_get_post_types());
...
ESSBOptionsStructureHelper::field_checkbox_list('subscribe', 'optin-12', 'essb3_ofof|posttypes', esc_html__('Appear only on selected post types', 'essb'), esc_html__('Limit function to work only on selected post types. Leave non option selected to make it work on all', 'essb'), essb_get_post_types());
