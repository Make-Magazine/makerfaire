...
if (!essb_option_bool_value('deactivate_module_clicktochat')) {
	ESSBOptionsStructureHelper::menu_item('chat', 'clicktochat', esc_html__('Click To Chat: WhatsApp, Viber', 'essb'), 'ti-facebook');
		...
		ESSBOptionsStructureHelper::field_checkbox_list('chat', 'clicktochat', 'click2chat_posttypes', esc_html__('Appear only on selected post types', 'essb'), esc_html__('Limit function to work only on selected post types. Leave non option selected to make it work on all', 'essb'), essb_get_post_types());
...
if (!essb_option_bool_value('deactivate_module_skypechat')) {
	...
	if (!ESSBActivationManager::isActivated()) {
		...
		ESSBOptionsStructureHelper::field_checkbox_list('chat', 'skypechat', 'skype_posttypes', esc_html__('Appear only on selected post types', 'essb'), esc_html__('Limit function to work only on selected post types. Leave non option selected to make it work on all', 'essb'), essb_get_post_types());
...
if (!essb_option_bool_value('deactivate_module_natives')) {
	...
	if (essb_option_bool_value('native_active')) {
		...
		ESSBOptionsStructureHelper::field_section_start_full_panels('natives', 'native-1');
		ESSBOptionsStructureHelper::field_switch_panel('natives', 'native-1', 'facebook_like_button', esc_html__('Include Facebook Like/Follow Button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		...
		ESSBOptionsStructureHelper::field_switch_panel('natives', 'native-1', 'facebook_like_button_api', esc_html__('My site already uses Facebook Api', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		ESSBOptionsStructureHelper::field_switch_panel('natives', 'native-1', 'facebook_like_button_api_async', esc_html__('Load Facebook API asynchronous', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		ESSBOptionsStructureHelper::field_textbox_panel('natives', 'native-1', 'facebook_like_button_width', esc_html__('Set custom width of Facebook like button to fix problem with not rendering correct. Value must be number without px in it.', 'essb'), esc_html__('', 'essb'));
		ESSBOptionsStructureHelper::field_textbox_panel('natives', 'native-1', 'facebook_like_button_height', esc_html__('Set custom height of Facebook like button to fix problem with not rendering correct. Value must be number without px in it.', 'essb'), esc_html__('', 'essb'));
		ESSBOptionsStructureHelper::field_textbox_panel('natives', 'native-1', 'facebook_like_button_margin_top', esc_html__('Set custom margin-top (to move up use negative value) of Facebook like button to fix problem with not rendering correct. Value must be number without px in it.', 'essb'), esc_html__('', 'essb'));
		...
		ESSBOptionsStructureHelper::field_textbox_stretched('natives', 'native-1', 'facebook_follow_profile', esc_html__('Facebook Follow Profile Page URL', 'essb'), esc_html__('', 'essb'));
		...
		ESSBOptionsStructureHelper::field_switch('natives', 'native-1', 'twitterfollow', esc_html__('Twitter Tweet/Follow Button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		...
		ESSBOptionsStructureHelper::field_textbox_stretched('natives', 'native-1', 'twitterfollowuser', esc_html__('Twitter Follow User', 'essb'), esc_html__('', 'essb'));
		ESSBOptionsStructureHelper::panel_end('natives', 'native-1');
		...
		ESSBOptionsStructureHelper::field_switch('natives', 'native-1', 'youtubesub', esc_html__('YouTube channel subscribe button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		ESSBOptionsStructureHelper::field_textbox_stretched('natives', 'native-1', 'youtubechannel', esc_html__('Channel ID', 'essb'), esc_html__('', 'essb'));
		ESSBOptionsStructureHelper::panel_end('natives', 'native-1');
		...
		ESSBOptionsStructureHelper::field_switch('natives', 'native-1', 'pinterestfollow', esc_html__('Include Pinterest Pin/Follow Button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		...
		ESSBOptionsStructureHelper::field_textbox_stretched('natives', 'native-1', 'pinterestfollow_disp', esc_html__('Text on button when follow type is selected', 'essb'), esc_html__('', 'essb'));
		...
		ESSBOptionsStructureHelper::field_switch('natives', 'native-1', 'linkedin_follow', esc_html__('Include LinkedIn button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		ESSBOptionsStructureHelper::field_textbox_stretched('natives', 'native-1', 'linkedin_follow_id', esc_html__('Company ID', 'essb'), esc_html__('', 'essb'));
		ESSBOptionsStructureHelper::panel_end('natives', 'native-1');
		...
		ESSBOptionsStructureHelper::field_switch('natives', 'native-1', 'managedwp_button', esc_html__('Include ManagedWP.org Upvote Button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		ESSBOptionsStructureHelper::panel_end('natives', 'native-1');
		...
		ESSBOptionsStructureHelper::field_switch('natives', 'native-1', 'vklike', esc_html__('Include VK.com Like Button', 'essb'), esc_html__('', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
		...
		foreach (essb_default_native_buttons() as $network) {
			...
			ESSBOptionsStructureHelper::field_color('natives', 'native-2', 'skinned_'.$network.'_color', esc_html__('Skinned button color replace', 'essb'), esc_html__('', 'essb'));
			ESSBOptionsStructureHelper::field_color('natives', 'native-2', 'skinned_'.$network.'_hovercolor', esc_html__('Skinned button hover color replace', 'essb'), esc_html__('', 'essb'));
			ESSBOptionsStructureHelper::field_color('natives', 'native-2', 'skinned_'.$network.'_textcolor', esc_html__('Skinned button text color replace', 'essb'), esc_html__('', 'essb'));
