...
ESSBOptionsStructureHelper::field_select_panel('style', 'my-template', 'mytemplate_nameweight', esc_html__('Network name text style', 'essb'), esc_html__('', 'essb'), array("" => "Default", "normal" => "Normal", "bold" => "Bold", "italic" => "Italic"));
ESSBOptionsStructureHelper::field_select_panel('style', 'my-template', 'mytemplate_texttrans', esc_html__('Network name text transform', 'essb'), esc_html__('', 'essb'), array("" => "Default", "uppercase" => "Uppercase", "capitalaize" => "Capitalize"));
