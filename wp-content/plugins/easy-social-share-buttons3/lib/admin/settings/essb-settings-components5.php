...
<div class="essb-options-hint essb-options-hint-glowstyles">
	...
	<div class="essb-options-hint-withicon">
		...
		<div class="essb-options-hint-buttons button-part">
			<a href="#" class="essb-style-apply" data-position="<?php echo esc_attr($position);?>"><i class="ti-ruler-pencil"></i> <span>Apply Style From Library</span></a>
			<?php if ($show_save == 'true'): ?>
				<a href="#" class="essb-style-save" data-position="<?php echo esc_attr($position);?>"><i class="ti-save"></i> <span>Save to Library</span></a>
			<?php endif; ?>
		</div>
