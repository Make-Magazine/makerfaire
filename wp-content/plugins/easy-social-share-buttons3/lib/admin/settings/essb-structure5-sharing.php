...
if (class_exists('ESSBControlCenter')) {
	...
	ESSBControlCenter::register_sidebar_section_menu_sub('social', 'share-1', 'networks_desc1', array('type' => 'description', 'value' => esc_html__('At the network setup, you can select the social networks that will be used on site. You can also control the appearance of each on different devices without applying specific mobile rules. With the advanced display position settings, you are also able to choose a personalized network list (different than one selected here).', 'essb')));
	...
	ESSBControlCenter::register_sidebar_section_menu_sub('social', 'share-1', 'networks_help_btn1', array('type' => 'button', 'value' => array( 'text' => esc_html__('Help with network setup', 'essb'), 'url' => 'https://docs.socialsharingplugin.com/knowledgebase/social-sharing-setup-social-networks/', 'target' => '_blank')));
	ESSBControlCenter::register_sidebar_section_menu_sub('social', 'share-1', 'networks_help_btn2', array('type' => 'button', 'value' => array( 'text' => esc_html__('Working with More button', 'essb'), 'url' => 'https://docs.socialsharingplugin.com/knowledgebase/social-sharing-how-to-set-up-more-button/', 'target' => '_blank')));
	ESSBControlCenter::register_sidebar_section_menu_sub('social', 'share-1', 'networks_help_btn3', array('type' => 'button', 'value' => array( 'text' => esc_html__('Help with Pinterest share modes', 'essb'), 'url' => 'https://docs.socialsharingplugin.com/knowledgebase/pinterest-share-button-modes-what-is-the-difference-and-which-of-them-to-use-on-site/', 'target' => '_blank')));
...
ESSBOptionsStructureHelper::field_select('social', 'share-1|networks', 'user_sort', esc_html__('Share buttons ordering', 'essb'), esc_html__('Dynamic sort by shares requires the share counters to be working on your site. The dynamic sort may hide share buttons that do not have counter value available. The function cannot work with real-time counters.', 'essb'), $network_sort_order);
ESSBOptionsStructureHelper::field_switch('social', 'share-1|networks', 'user_fixed_networks', esc_html__('Use everywhere the selected networks', 'essb'), esc_html__('Set to Yes and plugin will set the selected in global list networks everywhere on site (locations, mobile and etc.). This will also limit you from changing the networks on Location or Device settings.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'), '', '');
...
if (essb_is_active_social_network('mail')) {
	...
	ESSBOptionsStructureHelper::field_textbox_stretched('social', 'share-1|advanced', 'mail_subject', esc_html__('Subject', 'essb'), esc_html__('Variables: %%title%%, %%siteurl%%, %%permalink%%, %%shorturl%%, %%image%%', 'essb'));
	ESSBOptionsStructureHelper::field_textarea('social', 'share-1|advanced', 'mail_body', esc_html__('Message', 'essb'), esc_html__('Variables: %%title%%, %%siteurl%%, %%permalink%%, %%shorturl%%, %%image%%', 'essb'));
...
ESSBOptionsStructureHelper::field_heading('social', 'sharecnt', 'heading6', esc_html__('Additional Share Counter Options & Features', 'essb'), '', 'essb-counters-heading');
...
ESSBOptionsStructureHelper::field_section_start('social', 'sharecnt', esc_html__('Counter update options for all networks that does not provide direct access to counter API or does not have share counter and uses internal counters', 'essb'), esc_html__('', 'essb'), '');
...
ESSBOptionsStructureHelper::field_switch('social', 'sharecnt', 'admin_ajax_cache', esc_html__('Activate', 'essb'), esc_html__('', 'essb'), 'yes', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
...
if (!essb_option_bool_value('deactivate_module_pinterestpro')) {
	...
	ESSBOptionsStructureHelper::help('social', 'pinpro', '', '', array('Help With Settings' => 'https://docs.socialsharingplugin.com/knowledgebase/sharing-images-with-pinterest-pro-setup-tools/'));
		...
		ESSBOptionsStructureHelper::panel_start('social', 'pinpro', esc_html__('Tools for Images', 'essb'), esc_html__('Activate additional helpful tools to prepare your images and take a full control over the Pins', 'essb'), 'fa21 fa fa-pinterest', array("mode" => "toggle", "state" => "closed", "css_class" => "essb-auto-open"));
		...
		ESSBOptionsStructureHelper::panel_start('social', 'pinpro', esc_html__('Image Pin Button on Hover', 'essb'), esc_html__('Set to Yes if you wish to have Pin button for your content images.', 'essb'), 'fa32 fa fa-pinterest', array("mode" => "switch", 'switch_id' => 'pinterest_images', 'switch_on' => esc_html__('Yes', 'essb'), 'switch_off' => esc_html__('No', 'essb')));
		$location = 'pinterest';
		ESSBOptionsStructureHelper::structure_row_start('social', 'pinpro');
		ESSBOptionsStructureHelper::structure_section_start('social', 'pinpro', 'c6');
		...
		ESSBOptionsStructureHelper::field_toggle_panel('social', 'pinpro', $location.'_button_size', esc_html__('Button Size', 'essb'), esc_html__('Change size of exisiting template. May not work properly for all templates.', 'essb'), $select_values, '', '', 'button_size');
		...
		ESSBOptionsStructureHelper::field_select('social', 'pinpro', 'pinterest_position', esc_html__('Position Over Image', 'essb'), esc_html__('Choose the location of the button over the selected image', 'essb'), $list_of_positions, '', '6');
		ESSBOptionsStructureHelper::field_textbox('social', 'pinpro', 'pinterest_hideon', esc_html__('Don\'t Show On', 'essb'), esc_html__('In case you need to hide button on specific images you can write a relative path here.', 'essb'), '', '' ,'', '', '6');
		ESSBOptionsStructureHelper::field_textbox('social', 'pinpro', 'pinterest_selector', esc_html__('Custom Image Selector', 'essb'), esc_html__('Use only if you need to change the place where images are located. In all other situations leave it blank to work with default setup.', 'essb'), '', '' ,'', '', '6');
		...
		//-- shortcode styles
		$location = 'pinsc';
		ESSBOptionsStructureHelper::panel_start('social', 'pinpro', esc_html__('Pinterest Pro Shortcodes: Image & Gallery Pin Button Style', 'essb'), esc_html__('Change the design and visual style of the Pin button that is used for special Pinterest images or galleries added from plugin shortcodes', 'essb'), 'fa21 fa fa-pinterest', array("mode" => "toggle", "state" => "closed", "css_class" => "essb-auto-open"));
		ESSBOptionsStructureHelper::structure_row_start('social', 'pinpro');
		ESSBOptionsStructureHelper::structure_section_start('social', 'pinpro', 'c6');
		ESSBOptionsStructureHelper::title('social', 'pinpro', esc_html__('Template', 'essb'), '', 'inner-row');
		ESSBOptionsStructureHelper::field_template_select('social', 'pinpro', $location.'_template', $location, 'pinterest');
...
function essb5_additional_counter_options() {
	if (!essb_option_bool_value('deactivate_ansp')) {
		echo essb5_generate_code_advanced_settings_panel(
				...
				'avoid-negative-proof', '', esc_html__('Configure', 'essb'), 'ti-settings', 'no', '500');
	...
	if (!essb_option_bool_value('deactivate_ssr')) {
		echo essb5_generate_code_advanced_settings_panel(
				...
				'share-recovery', '', esc_html__('Configure', 'essb'), 'ti-settings', 'no', '500');		
	}
	
	echo essb5_generate_code_advanced_settings_panel(
			esc_html__('Single Button Share Counter Options', 'essb'),
			esc_html__('Manage the shortening of share value inside the single share button counter display and/or activate animation of the value.', 'essb'),
			'single-counter', '', esc_html__('Configure', 'essb'), 'ti-settings', 'no', '500');

	echo essb5_generate_code_advanced_settings_panel(
			esc_html__('Total Share Counter Options', 'essb'),
			esc_html__('Configure additional design options related to the total counter positions (change text, icon, animation, etc.).', 'essb'),
...
function essb5_advanced_adaptive_styles() {
	echo essb5_generate_code_advanced_settings_panel(
			esc_html__('Automatic Position & Mobile Share Button Styles', 'essb'),
			esc_html__('With automatic position and mobile styles, you can save time by letting plugin choose the best design for locations you will use. The automatic styles will set up the most used design for each location applying the values you already have. This will also eliminate the style setup on each location. In case you did not like the design you can stop the automatic position styles and manually set the design. The automatic mobile styles will set an automated mobile share bar with a responsive mode trigger. You will be able also to set up automatic content responsive designs too.', 'essb'),
			'adaptive-styles', '', esc_html__('Configure', 'essb'), 'ti-settings', 'no', '600', '', 'ti-widget');
