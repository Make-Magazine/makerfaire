...
essb5_draw_heading( esc_html__('Position Setup', 'essb'), '5');
...
essb5_draw_heading( esc_html__('Mobile Setup', 'essb'), '5');

if (essb_option_value('functions_mode_mobile') != 'auto' && essb_option_value('functions_mode_mobile') != 'deactivate') {
	essb5_draw_switch_option('activate_automatic_mobile', esc_html__('Activate Automatic Mobile Setup', 'essb'), esc_html__('Activate to make plugin automatically set share buttons on mobile. They will come with responsive mobile triggers to ensure proper work on all devices. Save time for new users or those that do not have specific mobile needs.', 'essb'));
}
