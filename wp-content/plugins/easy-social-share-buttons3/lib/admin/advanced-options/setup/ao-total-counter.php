...
essb5_draw_heading(esc_html__('Left/Right Total Counter Position', 'essb'), '4');
...
essb5_draw_heading( esc_html__('Left/Right Total Counter With Big Number (and optional icon)', 'essb'), '4');
...
essb5_draw_heading(esc_html__('Before/After Share Buttons Total Counter Position', 'essb'), '4');
...
essb5_draw_heading( esc_html__('Global Counter Settings', 'essb'), '4');
