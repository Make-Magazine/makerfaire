...
function essb_register_settings_metabox_optimize() {
	...
	if (isset($_GET['action'])) {
		...
		ESSBOptionsFramework::draw_help('', '', '', array('buttons' => array('Twitter Sharing Wrong URL' => 'https://docs.socialsharingplugin.com/knowledgebase/twitter-share-wrong-url-how-to-fix-it/')));
		...
		if (essb_option_bool_value('activate_ga_tracking')) {
			...
			ESSBOptionsFramework::draw_options_row_start(esc_html__('', 'essb'), esc_html__('', 'essb'), '', '2', false);
...
function essb_register_settings_metabox_visual() {
	...
	if (isset ( $_GET ['action'] )) {
		...
		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Counters', 'essb'), esc_html__('', 'essb'));
		ESSBMetaboxOptionsFramework::draw_select_field('essb_post_counters', $yesno_object, false, 'essb_metabox', $essb_post_counters);
		ESSBMetaboxOptionsFramework::draw_options_row_end();

		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Counter position', 'essb'), esc_html__('', 'essb'));
		...
		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Total counter position', 'essb'), esc_html__('', 'essb'));
		...
		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Activate style customizer', 'essb'), esc_html__('', 'essb'));
		ESSBMetaboxOptionsFramework::draw_select_field('essb_post_customizer', $yesno_object, false, 'essb_metabox', $essb_post_customizer);
		ESSBMetaboxOptionsFramework::draw_options_row_end();

		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Activate animations', 'essb'), esc_html__('', 'essb'));
		...
		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Activate options by button position', 'essb'), esc_html__('', 'essb'));
		...
		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Activate native buttons', 'essb'), esc_html__('', 'essb'));
		ESSBMetaboxOptionsFramework::draw_select_field('essb_post_native', $yesno_object, false, 'essb_metabox', $essb_post_native);
		ESSBMetaboxOptionsFramework::draw_options_row_end();

		ESSBMetaboxOptionsFramework::draw_options_row_start(esc_html__('Activate native buttons skin', 'essb'), esc_html__('', 'essb'));
