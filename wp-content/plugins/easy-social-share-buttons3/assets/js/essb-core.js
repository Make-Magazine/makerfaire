...
( function( $ ) {
	...
	essb.copy_link = function(instance_id) {
		...
		if (!$('.essb-copylink-window').length) {
			...
			output.push('<div style="width:50px;text-align: center;"><a href="#" class="essb-copy-link" title="Press to copy the link" style="color:#5867dd;background:#fff;padding:10px;text-decoration: none;"><i class="essb_icon essb_icon_copy"></i></a></div>');
			output.push('</div>');
			...
			$('.essb-copylink-window .essb-copy-link').on('click', function(e) {
				...
				try {
					...
					$('.essb-copylink-window .essb_morepopup_header span').html('Copied to clipboard.');
					setTimeout(function() {
						$('.essb-copylink-window .essb_morepopup_header span').html('&nbsp;');
					}, 2000);
				}
				catch (e) {
					$('.essb-copylink-window .essb_morepopup_header span').html('Please use Ctrl/Cmd+C to copy the URL.');
					setTimeout(function() {
						$('.essb-copylink-window .essb_morepopup_header span').html('&nbsp;');
					}, 2000);
				}
	...
	$(document).ready(function(){
		...
		if (essb_settings.pin_pinid_active && essb_settings.pin_pinid) {
			$('img').each(function() {
				$(this).attr('data-pin-id', essb_settings.pin_pinid);
			});
		}
		...
		var essbPinImagesGenerateButtons = function() {
			...
			if (image.hasClass('no_pin') || image.hasClass('no-pin') || image.data('pin-nopin') || image.hasClass('pin-generated') || image.hasClass('pin-process')) return;
			...
			shareBtnCode.push('<a class="nolightbox" href="'+shareCmd+'" onclick="essb.window(&#39;'+shareCmd+'&#39;,&#39;pinpro&#39;,&#39;'+uid+'&#39;); return false;" target="_blank"><span class="essb_icon essb_icon_pinterest"></span><span class="essb_network_name">'+(essbPinImages['text'] ? essbPinImages['text'] : 'Pin')+'</span></a>');
