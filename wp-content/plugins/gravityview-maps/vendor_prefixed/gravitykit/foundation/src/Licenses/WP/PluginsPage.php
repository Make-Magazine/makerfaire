...
JS;
			...
			if ( ! $product['active'] ) {
				...
				if ( ! $product['free'] && empty( $product['licenses'] ) ) {
					$links['activate'] = sprintf(
						...
						esc_html__( 'This product requires a license key to be activated. Click this link to enter your license key.', 'gk-gravitymaps' ),
	...
	public function group_products( $wp_plugins ) {
		...
		add_filter( 'plugin_row_meta', function ( $wp_plugin_meta, $wp_plugin_file, $wp_plugin_data ) {
			...
			return [
				'<a href="https://gravitykit.com">' . esc_html__( 'Visit GravityKit.com', 'gk-gravitymaps' ) . '</a>'
			];
		}, 10, 4 );
