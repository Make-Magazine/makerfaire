...
define( 'GWP_ADVANCED_MERGE_TAGS_VERSION', '1.9.1' );
...
class GWP_Advanced_Merge_Tags_Bootstrap {
	...
	public static function load_addon() {
		...
		if ( class_exists( 'GravityView_Extension' ) && ( class_exists( 'GravityView_Advanced_Filtering' ) || class_exists( '\GravityKit\AdvancedFilter\Core' ) ) ) {
