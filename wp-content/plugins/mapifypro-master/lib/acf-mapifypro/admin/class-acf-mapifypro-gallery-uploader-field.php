...
if( ! class_exists( 'Acf_Mapifypro_Gallery_Uploader_Field' ) ) :


class Acf_Mapifypro_Gallery_Uploader_Field extends acf_field {
	...
	function __construct( $settings ) {
		...
		$this->label = __( 'Mapify Gallery Uploader', 'acf-mapifypro' );
	...
	function render_field( $field ) {		
		...
		$gallery      = array();
		$empty_notice = sprintf( '<span>%s</span>', __( 'No images yet. Press <b>Add Images</b> button to start.', 'acf-mapifypro' ) );
		...
		new Acf_Mapifypro_Fegallery( array(
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-mapifypro-gallery-uploader', "{$url}admin/js/script-gallery-uploader.js", array( 'jquery', 'acf-input' ), $version );
		wp_enqueue_script( 'acf-mapifypro-gallery-uploader' );
	...
	*/
	...
	function update_value( $value, $post_id, $field ) {	
		...
		$image_urls          = isset( $value['image_url'] ) ? $value['image_url'] : array();
		$mapify_map_location = new Mapify_Map_Location( $post_id );
		$mapify_map_location->set_gallery_images( $image_urls );
	...
	*/
	...
	function load_field( $field ) {
		...
		// set instruction
		$field['instructions'] = __( 'Add your desired images from the gallery. You can always edit the image URL after it. The images will also be used for Google Rich Results data.', 'acf-mapifypro' );
