<div <?php acf_esc_attr_e( $attrs ); ?>>
	...
	<div class="acf-osm-maptiles osm-media-uploader">
		<div class="acf-osm-maptiles-input">
			...
			placeholder="<?php esc_attr_e( 'Your image URL', 'acf-mapifypro' ) ?>" value='<?php echo esc_url( $image_url ) ?>' class='maptiles-image-url' id='mapify-pin-image'>
		...
		<div class="acf-osm-maptiles-button">
			<button class="button maptiles-select-image"><?php esc_html_e( 'Select an Image', 'acf-mapifypro' ) ?></button>
		</div>
