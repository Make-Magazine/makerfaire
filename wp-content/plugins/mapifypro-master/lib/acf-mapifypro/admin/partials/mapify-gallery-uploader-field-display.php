<div <?php acf_esc_attr_e( $attrs ); ?>>
	...
	<input type="hidden" name="<?php echo esc_attr( $field['name'] ) . '[type]' ?>" value="mapify_gallery_uploader" >
	...
	<div id="fegallery-button-container">
		<a class='button' id="fegallery-add-slide">
			...
			<?php esc_html_e( 'Add Images', 'acf-mapifypro' ) ?>
		</a>
	</div>
		...
		<table class="table-content">
			<tr>
				<td>
					...
					<label><?php esc_html_e( 'You can insert your custom image URL here', 'acf-mapifypro' ) ?></label>
				</td>
				<tr>
					<th class="button-th">
						<a href="javascript:;" class="button" id="fegallery-update-image-url"><?php esc_html_e( 'Update Image URL', 'acf-mapifypro' ) ?></a>
					</th>
				</tr>
			</tr>
		</table>
