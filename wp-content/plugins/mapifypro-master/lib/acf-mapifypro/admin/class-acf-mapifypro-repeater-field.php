...
if( ! class_exists('Acf_Mapifypro_Repeater_Fields') ) :

class Acf_Mapifypro_Repeater_Fields extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		// vars
		$this->name     = 'mapify_repeater';
		$this->label    = __("MapifyPro Repeater",'acf');
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-mapifypro-repeater', "{$url}admin/js/script-mapifypro-repeater.js", array( 'jquery', 'acf-input' ), $version );
		wp_enqueue_script( 'acf-mapifypro-repeater' );
