...
if( ! class_exists( 'Acf_Mapifypro_Maptiles_Uploader_Field' ) ) :


class Acf_Mapifypro_Maptiles_Uploader_Field extends acf_field {
	...
	function __construct( $settings ) {
		...
		$this->label = __( 'Mapify Map Tiles Uploader', 'acf-mapifypro' );
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			'label'        => __( 'Uploads Folder Name', 'acf-mapifypro' ),
			'instructions' => __( 'The uploads folder name. Will be located under `/wp-content/uploads/` folder', 'acf-mapifypro' ),
			'type'         => 'text',
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-mapifypro-maptiles-uploader', "{$url}admin/js/script-maptiles-uploader.js", array( 'jquery', 'acf-input' ), $version );
		wp_enqueue_script( 'acf-mapifypro-maptiles-uploader' );
	...
	*/
	...
	function load_field( $field ) {
		...
		// set instruction
		$field['instructions'] = __( 'You must save this map settings first, before the image can be processed to support multiple zoom levels.', 'acf-mapifypro' );
