...
class Mapify_ACF {
	...
	public function __construct() {
		...
		define( 'MAPIFY_ACF_PATH', MAPIFY_PLUGIN_DIR_PATH . '/lib/advanced-custom-fields-pro/' );
		define( 'MAPIFY_ACF_URL',  MAPIFY_PLUGIN_DIR_URL . '/lib/advanced-custom-fields-pro/' );
		...
		if( class_exists( 'ACF' ) ) {
			include_once( MAPIFY_PLUGIN_DIR_PATH . '/lib/acf-mapifypro/acf-mapifypro.php' );
		}
	}
