                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"><?php esc_html_e( 'Dear CrowdMaps contributor,', 'crowd' ) ?></p>
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"><?php esc_html_e( 'Congratulations, your contribution has been published!.', 'crowd' ) . printf( ' %s', $content ) ?></p>
                        
						<?php if ( $with_reset_password ) : ?>
						...
						<tbody>
							...
							<td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
								...
								<tbody>
									<tr>
									<td style="font-family: sans-serif; font-size: 14px; vertical-align: top; border-radius: 5px; text-align: center; background-color: #3498db;" valign="top" align="center" bgcolor="#3498db"> <a href="<?php echo wp_lostpassword_url() ?>" target="_blank" style="border: solid 1px #3498db; border-radius: 2px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 14px; font-weight: bold; margin: 0; padding: 5px 10px; text-decoration: none; text-transform: capitalize; background-color: #3498db; border-color: #3498db; color: #ffffff; box-shadow : 0 10px 22px rgba(0,0,0,0.35);"><?php esc_html_e( 'Create a password', 'crowd' ) ?></a> </td>
									</tr>
								</tbody>
								</table>
							</td>
						...
						<p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px; margin-top: 15px;"><?php esc_html_e( 'Your submitted map location:', 'crowd' ) ?></p>
			 ...
			 <div class="footer" style="clear: both; margin-top: 10px; text-align: center; width: 100%;">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;" width="100%">
                <tr>
				  ...
				  <a href="<?php echo site_url() ?>" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;"><?php echo site_url() ?></a>
                  </td>
                </tr>
              </table>
            </div>
