...
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\Admin as TrustedLoginAdmin;
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\Form as TrustedLoginForm;
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\SupportUser as TrustedLoginSupportUser;
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\SiteAccess as TrustedLoginSiteAccess;
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\Logging as TrustedLoginLogging;
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\Config as TrustedLoginConfig;
use GravityKit\GravityRevisions\Foundation\ThirdParty\TrustedLogin\Client as TrustedLoginClient;
...
class TrustedLogin {
	...
	public function add_gk_submenu_item() {
		...
		$page_title = esc_html__( 'Grant Support Access', 'gk-gravityrevisions' );
