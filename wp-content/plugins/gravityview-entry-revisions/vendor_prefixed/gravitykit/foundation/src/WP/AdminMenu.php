...
namespace GravityKit\GravityRevisions\Foundation\WP;
...
class AdminMenu {
	...
	public function add_admin_menu() {
		...
		// Add top-level menu.
		$page_title         = esc_html__( 'GravityKit', 'gk-gravityrevisions' );
		$menu_title         = esc_html__( 'GravityKit', 'gk-gravityrevisions' );
