...
namespace GravityKit\GravityRevisions\Foundation;

use GravityKit\GravityRevisions\Foundation\Components\NewsletterSignup;
use GravityKit\GravityRevisions\Foundation\Integrations\GravityForms;
use GravityKit\GravityRevisions\Foundation\Integrations\HelpScout;
...
use GravityKit\GravityRevisions\Foundation\Translations\Framework as TranslationsFramework;
...
HTML;
				...
				$general_settings = array_merge(
					...
					[
						...
						[
							...
							'type'        => 'select',
							'title'       => esc_html__( 'GravityKit Menu Position', 'gk-gravityrevisions' ),
							'description' => esc_html__( 'Select the menu below which to place the GravityKit menu.', 'gk-gravityrevisions' ),
						...
						[
							...
							'choices'     => $top_level_menu_action_choices,
							'title'       => esc_html__( 'GravityKit Menu Action', 'gk-gravityrevisions' ),
							'description' => esc_html__( 'Select the page to open when clicking the GravityKit menu.', 'gk-gravityrevisions' ),
						],
						[
							'id'          => 'powered_by',
							'type'        => 'checkbox',
							'value'       => Arr::get( $gk_settings, 'powered_by', $default_settings['powered_by'] ),
							'title'       => esc_html__( 'Display "Powered By" Link', 'gk-gravityrevisions' ),
							'description' => esc_html__( 'A "Powered by GravityKit" link will be displayed below some GravityKit products. Help us spread the word!', 'gk-gravityrevisions' ),
						],
						[
							'id'          => 'affiliate_id',
							'type'        => 'number',
							'value'       => Arr::get( $gk_settings, 'affiliate_id' ),
							'title'       => esc_html__( 'Affiliate ID', 'gk-gravityrevisions' ),
							'description' => strtr(
								esc_html_x( 'Earn money when people clicking your links become GravityKit customers. [link]Register as an affiliate[/link]!', 'Placeholders inside [] are not to be translated.', 'gk-gravityrevisions' ),
								[
						...
						[
							...
							'title'       => esc_html__( 'Become a Beta Tester', 'gk-gravityrevisions' ),
							'description' => esc_html__( 'You will have early access to the latest GravityKit products. There may be bugs! If you encounter an issue, report it to help make GravityKit products better!', 'gk-gravityrevisions' ),
						],
					]
				);
				...
				$support_settings = [
					[
						...
						'title'       => esc_html__( 'Support Email', 'gk-gravityrevisions' ),
						'description' => esc_html__( 'In order to provide responses to your support requests, please provide your email address.', 'gk-gravityrevisions' ),
						'validation'  => [
							[
								'rule'    => 'required',
								'message' => esc_html__( 'Support email is required', 'gk-gravityrevisions' ),
							],
							[
								'rule'    => 'email',
								'message' => esc_html__( 'Please provide a valid email address', 'gk-gravityrevisions' ),
							],
						],
					],
					[
						...
						'title'       => esc_html__( 'Show Support Port', 'gk-gravityrevisions' ),
						'description' => ( esc_html__( 'The Support Port provides quick access to how-to articles and tutorials. For administrators, it also makes it easy to contact support.', 'gk-gravityrevisions' ) .
						                   strtr(
							                   esc_html_x( '[image]Support Port icon[/image]', 'Placeholders inside [] are not to be translated.', 'gk-gravityrevisions' ),
							                   [
				...
				$technical_settings = [
					[
						...
						'title'       => esc_html__( 'Enable No-Conflict Mode', 'gk-gravityrevisions' ),
						'description' => esc_html__( 'No-conflict mode prevents extraneous scripts and styles from being printed on GravityKit admin pages, reducing conflicts with other plugins and themes.', 'gk-gravityrevisions' ),
					],
				];
				...
				$all_settings = [
					self::ID => [
						...
						'sections' => [
							[
								'title'    => esc_html__( 'General', 'gk-gravityrevisions' ),
								'settings' => $general_settings,
							],
							[
								'title'    => esc_html__( 'Support', 'gk-gravityrevisions' ),
								'settings' => $support_settings,
							],
							[
								'title'    => esc_html__( 'Technical', 'gk-gravityrevisions' ),
