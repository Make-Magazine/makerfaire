...
use GravityKit\GravityRevisions\Foundation\ThirdParty\Gettext\Utils\StringReader;
...
class Mo extends Extractor implements ExtractorInterface
{
    ...
    protected static $stringReaderClass = 'GravityKit\GravityRevisions\Foundation\ThirdParty\Gettext\Utils\StringReader';
