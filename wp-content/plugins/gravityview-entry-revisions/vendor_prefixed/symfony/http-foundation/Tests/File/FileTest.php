...
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\File;
...
class FileTest extends TestCase
{
    ...
    public function testMove()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\File', $movedFile);
    ...
    {
        $guesser = $this->getMockBuilder('GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface')->getMock();
        $guesser
            ->expects($this->once())
            ->method('guess')
