...
namespace GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Tests\File\MimeType;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesser;
...
class MimeTypeTest extends TestCase
{
    ...
    {
        $this->expectException('GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\Exception\FileNotFoundException');
    ...
    public function testGuessWithNonReadablePath()
    {
        ...
        if ('0333' == substr(sprintf('%o', fileperms($path)), -4)) {
            $this->expectException('GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\File\Exception\AccessDeniedException');
