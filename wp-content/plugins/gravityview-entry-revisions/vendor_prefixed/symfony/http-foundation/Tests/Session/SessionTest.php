...
namespace GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Tests\Session;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\Flash\FlashBag;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityRevisions\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityRevisions\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
