    ...
    public function get_posts()
    {
        ...
        if (isset($q['caller_get_posts'])) {
            _deprecated_argument(
                ...
                \sprintf(__('%1$s is deprecated. Use %2$s instead.', 'dynamic-content-for-elementor'), '<code>caller_get_posts</code>', '<code>ignore_sticky_posts</code>')
            );
        ...
        if (!isset($q['update_post_term_cache'])) {
            $q['update_post_term_cache'] = \true;
        }
        if (!isset($q['lazy_load_term_meta'])) {
            $q['lazy_load_term_meta'] = $q['update_post_term_cache'];
        }
        if (!isset($q['update_post_meta_cache'])) {
            $q['update_post_meta_cache'] = \true;
        }
        ...
        if (isset($q['comment_count'])) {
            ...
            if (isset($q['comment_count']['value'])) {
                ...
                if (!\in_array($q['comment_count']['compare'], $compare_operators, \true)) {
        ...
        if (isset($q['orderby']) && \in_array($q['orderby'], $force_asc, \true)) {
            $q['order'] = '';
        }
        // Order by.
        if (empty($q['orderby'])) {
        ...
        if (!empty($q['post_status'])) {
            ...
            // Add public states.
            $public_states = get_post_statuses(array('public' => \true));
            ...
            if ($this->is_admin) {
                ...
                $admin_all_states = get_post_statuses(array('protected' => \true, 'show_in_admin_all_list' => \true));
            ...
            if (is_user_logged_in()) {
                ...
                $private_states = get_post_statuses(array('private' => \true));
        ...
        if ($this->is_home && $page <= 1 && \is_array($sticky_posts) && !empty($sticky_posts) && !$q['ignore_sticky_posts']) {
            ...
            if (!empty($sticky_posts)) {
                $stickies = get_posts(array('post__in' => $sticky_posts, 'post_type' => $post_type, 'post_status' => 'publish', 'nopaging' => \true));
