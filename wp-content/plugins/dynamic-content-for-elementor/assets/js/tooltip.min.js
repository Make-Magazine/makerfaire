...
if(target.length){target=target.toArray()}else{console.error('Dynamic Tooltip: Selector not found');return}
...
if(elementSettings.dce_tooltip_content){tippy(target,{content:elementSettings.dce_tooltip_content,arrow:arrow,allowHTML:!0,followCursor:followCursor,maxWidth:maxWidth,theme:'theme_'+$scope.data('id'),})}}};$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/global',WidgetElements_TooltipHandler)})})(jQuery)