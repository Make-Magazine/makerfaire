...
map.fitBounds(bounds);if(!elementSettingsMap.auto_zoom){var listener=google.maps.event.addListener(map,"idle",function(){map.setZoom(zoom);google.maps.event.removeListener(listener)})}}
