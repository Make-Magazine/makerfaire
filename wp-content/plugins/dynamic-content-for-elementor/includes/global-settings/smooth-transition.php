...
class DCE_Settings_SmoothTransition extends \DynamicContentForElementor\Includes\Settings\DCE_Settings_Prototype
{
    ...
    public static function get_controls()
    {
        ...
        return ['label' => __('Smooth Transition', 'dynamic-content-for-elementor'), 'controls' => [
            'enable_smoothtransition' => ['label' => __('Smooth Transition', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'label_off' => __('No', 'dynamic-content-for-elementor'), 'label_on' => __('yes', 'dynamic-content-for-elementor'), 'return_value' => 'yes', 'default' => '', 'frontend_available' => \true, 'separator' => 'before'],
            ...
            'smoothtransition_enable_overlay' => ['label' => __('Use overlay', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'label_off' => __('No', 'dynamic-content-for-elementor'), 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'return_value' => 'yes', 'default' => '', 'frontend_available' => \true, 'condition' => ['enable_smoothtransition' => 'yes', 'dce_smoothtransition_class_controller!' => '']],
            ...
            'smoothtransition_loading_mode' => ['label' => __('Loading Mode', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['circle' => ['title' => __('Circle', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle-o-notch'], 'image' => ['title' => __('Image', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-picture-o'], 'none' => ['title' => __('None', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-ban']], 'render_type' => 'template', 'default' => 'circle', 'condition' => ['enable_smoothtransition' => 'yes', 'dce_smoothtransition_class_controller!' => ''], 'frontend_available' => \true],
