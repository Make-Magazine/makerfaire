...
class DCE_Widget_ThreesixtySlider extends \DynamicContentForElementor\Widgets\DCE_Widget_Prototype
{
    ...
    protected function _register_controls_content()
    {
        ...
        $this->add_control('responsive', ['label' => __('Responsive', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::HIDDEN, 'default' => 'yes', 'return_value' => 'yes', 'frontend_available' => \true]);
