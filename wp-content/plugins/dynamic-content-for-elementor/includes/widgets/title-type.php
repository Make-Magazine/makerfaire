...
class DCE_Widget_TitleType extends \DynamicContentForElementor\Widgets\DCE_Widget_Prototype
{
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section('section_titleType', ['label' => 'Type Title']);
