...
class DCE_Widget_SvgMorphing extends \DynamicContentForElementor\Widgets\DCE_Widget_Prototype
{
    ...
    protected function _register_controls_content()
    {
        ...
        $this->add_control('yoyo', ['label' => __('Yoyo', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => '', 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'label_off' => __('No', 'dynamic-content-for-elementor'), 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before', 'condition' => ['svg_trigger' => 'animation']]);
        $this->add_control('repeat_morph', ['label' => __('Repeat', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::NUMBER, 'label_block' => \false, 'frontend_available' => \true, 'description' => 'Infinite: -1 or do not repeat: 0', 'default' => -1, 'min' => -1, 'max' => 25, 'step' => 1, 'condition' => ['svg_trigger!' => 'rollover', 'one_by_one' => '']]);
        $this->end_controls_section();
        $this->start_controls_section('section_creative_svg', ['label' => __('SVG & Viewbox', 'dynamic-content-for-elementor')]);
        $this->add_control('type_of_shape', ['label' => __('Type of Shape', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SELECT, 'options' => $this->svg_shapes, 'default' => 'path', 'description' => __('Type of SVG sequence', 'dynamic-content-for-elementor'), 'frontend_available' => \true, 'label_block' => \true]);
        $this->add_control('enable_image', ['label' => __('Pattern image', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => '', 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'label_off' => __('No', 'dynamic-content-for-elementor'), 'return_value' => 'yes', 'frontend_available' => \true, 'separator' => 'before']);
        ...
        $repeater->add_control('id_shape', ['label' => 'ID', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'shape-']);
