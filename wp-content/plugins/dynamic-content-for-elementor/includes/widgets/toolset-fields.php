...
class DCE_Widget_Toolset extends \DynamicContentForElementor\Widgets\DCE_Widget_Prototype
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('toolset_field_hide', ['label' => __('Hide if empty', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'label_off' => __('No', 'dynamic-content-for-elementor'), 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'default' => 'yes', 'description' => 'Hide the field in front end layer']);
        $this->end_controls_section();
        $this->start_controls_section('section_settings', ['label' => 'Settings', 'condition' => ['toolset_field_type!' => 'video']]);
        ...
        $this->add_control('toolset_url_enable', ['label' => __('Link', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'label_off' => __('No', 'dynamic-content-for-elementor'), 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'default' => 'yes', 'condition' => ['toolset_field_type' => 'url']]);
        ...
        $this->add_control('bg_extend', ['label' => __('Extend background', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => '', 'label_on' => __('Show', 'dynamic-content-for-elementor'), 'label_off' => __('Hide', 'dynamic-content-for-elementor'), 'return_value' => 'yes', 'condition' => ['use_bg' => '1'], 'prefix_class' => 'extendbg-', 'condition' => ['toolset_field_type' => 'image', 'use_bg' => '1']]);
        $this->add_responsive_control('height', ['label' => __('Minimus height', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SLIDER, 'default' => ['size' => 200, 'unit' => 'px'], 'tablet_default' => ['unit' => 'px'], 'mobile_default' => ['unit' => 'px'], 'size_units' => ['px', '%', 'vh'], 'range' => ['%' => ['min' => 1, 'max' => 100], 'px' => ['min' => 1, 'max' => 1000], 'vh' => ['min' => 1, 'max' => 100]], 'selectors' => ['{{WRAPPER}} .dynamic-content-for-elementor-toolset-bg' => 'min-height: {{SIZE}}{{UNIT}};'], 'condition' => ['toolset_field_type' => 'image', 'use_bg' => '1']]);
        ...
        $this->add_control('toolset_numeric_currency', ['label' => __('Currency', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'label_off' => __('No', 'dynamic-content-for-elementor'), 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'default' => 'no', 'condition' => ['toolset_field_type' => 'numeric']]);
