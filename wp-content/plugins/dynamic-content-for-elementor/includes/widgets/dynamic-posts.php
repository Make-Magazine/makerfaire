...
class DCE_Widget_DynamicPosts extends \DynamicContentForElementor\Widgets\DCE_Widget_Prototype
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('deprecated', ['raw' => __('This widget is deprecated. You can continue to use it but we recommend that you use Dynamic Posts v2 instead.', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::RAW_HTML, 'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning']);
        ...
        $this->add_control('combination_taxonomy', ['label' => __('<b>Include</b> Combination', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['AND' => ['title' => __('AND', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle'], 'OR' => ['title' => __('OR', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle-o']], 'toggle' => \false, 'default' => 'OR', 'condition' => ['taxonomy!' => '', 'terms_current_post' => '']]);
        //
        foreach ($taxonomies as $tkey => $atax) {
            if ($tkey) {
        ...
        $this->add_control('combination_taxonomy_excluse', ['label' => __('<b>Exclude</b> Combination', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['OR' => ['title' => __('AND', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle'], 'AND' => ['title' => __('OR', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle-o']], 'toggle' => \false, 'default' => 'OR', 'condition' => ['taxonomy!' => '', 'terms_current_post' => '']]);
        ...
        $this->add_control('usePagination', ['label' => __('Use Pagination', 'dynamic-content-for-elementor'), 'description' => __('If "yes", use the slide progression display system ("bullets", "fraction", "progress").', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes', 'frontend_available' => \true]);
        ...
        $this->add_control('useScrollbar', ['label' => __('Use Scrollbar', 'dynamic-content-for-elementor'), 'description' => __('If "yes", you will use a scrollbar that displays navigation', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'default' => '', 'label_on' => __('Yes', 'dynamic-content-for-elementor'), 'label_off' => __('No', 'dynamic-content-for-elementor'), 'return_value' => 'yes']);
        // -------------------------------- Autoplay ------
        ...
        */
        ...
        $this->add_responsive_control('size_image', [
            ...
            'selectors' => ['{{WRAPPER}} .dce-acfposts_image > *' => 'max-width: {{SIZE}}{{UNIT}};'],
            'condition' => ['show_image' => '1'],
        ]);
        // Link Image
        ...
        $repeater->add_control('link', ['label' => __('Link', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::URL, 'placeholder' => 'http://your-link.com', 'condition' => ['link_to' => 'custom'], 'default' => ['url' => ''], 'show_label' => \false]);
