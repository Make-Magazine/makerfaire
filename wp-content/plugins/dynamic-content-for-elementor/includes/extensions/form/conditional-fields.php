...
class DCE_Extension_Form_Visibility extends \DynamicContentForElementor\Extensions\DCE_Extension_Prototype
{
    ...
    public static function _add_to_form(Controls_Stack $element, $control_id, $control_data, $options = [])
    {
        if ($element->get_name() == 'form' && $control_id == 'form_fields') {
            $control_data['fields']['form_fields_visibility_tab'] = array('type' => 'tab', 'tab' => 'visibility', 'label' => __('Condition', 'dynamic-content-for-elementor'), 'tabs_wrapper' => 'form_fields_tabs', 'name' => 'form_fields_visibility_tab');
            $control_data['fields']['dce_field_visibility_deprecated'] = array('name' => 'dce_field_visibility_deprecated', 'raw' => __('This extension is deprecated. You can continue to use it but we recommend that you use Conditional Fields v2 instead.', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::RAW_HTML, 'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning', 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab');
            $control_data['fields']['dce_field_visibility_mode'] = array('label' => __('Condition', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['visible' => ['title' => __('Always Visible', 'dynamic-content-for-elementor'), 'icon' => 'eicon-check'], 'show' => ['title' => __('Show if', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-eye'], 'hide' => ['title' => __('Hide if', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-eye-slash']], 'toggle' => \false, 'default' => 'visible', 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab', 'name' => 'dce_field_visibility_mode');
            $control_data['fields']['dce_field_visibility_multiple'] = array('name' => 'dce_field_visibility_multiple', 'type' => Controls_Manager::CHOOSE, 'label' => __('Multiple conditions', 'dynamic-content-for-elementor'), 'options' => ['single' => ['title' => __('Single', 'dynamic-content-for-elementor'), 'icon' => 'eicon-cog'], 'yes' => ['title' => __('Multiple', 'dynamic-content-for-elementor'), 'icon' => 'eicon-cogs']], 'condition' => array('dce_field_visibility_mode!' => 'visible'), 'default' => 'single', 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab');
            $control_data['fields']['dce_field_visibility_field'] = array('type' => Controls_Manager::TEXT, 'tab' => 'visibility', 'label' => __('Field ID', 'dynamic-content-for-elementor'), 'placeholder' => __('name', 'dynamic-content-for-elementor'), 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab', 'name' => 'dce_field_visibility_field', 'condition' => array('dce_field_visibility_mode!' => 'visible', 'dce_field_visibility_multiple' => ['', 'single', null]));
            $control_data['fields']['dce_field_visibility_field_multiple'] = array('name' => 'dce_field_visibility_field_multiple', 'label' => __('Field IDs', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'placeholder' => __('name,message', 'dynamic-content-for-elementor'), 'description' => __('Separate each field ID it with a comma', 'dynamic-content-for-elementor'), 'condition' => array('dce_field_visibility_mode!' => 'visible', 'dce_field_visibility_multiple' => 'yes'), 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab');
            $control_data['fields']['dce_field_visibility_operator'] = array('label' => __('Operator', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SELECT, 'options' => Helper::get_string_comparison(), 'default' => 'equal_to', 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab', 'name' => 'dce_field_visibility_operator', 'condition' => array('dce_field_visibility_mode!' => 'visible'));
            $control_data['fields']['dce_field_visibility_value'] = array('type' => Controls_Manager::TEXT, 'tab' => 'visibility', 'label' => __('Value', 'dynamic-content-for-elementor'), 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab', 'name' => 'dce_field_visibility_value', 'dynamic' => ['active' => \true], 'condition' => array('dce_field_visibility_mode!' => 'visible', 'dce_field_visibility_multiple' => ['', 'single', null], 'dce_field_visibility_operator' => array('equal_to', 'not_equal', 'gt', 'lt', 'ge', 'le', 'not_contain', 'contain', 'is_checked', 'not_checked')));
            $control_data['fields']['dce_field_visibility_value_multiple'] = array('name' => 'dce_field_visibility_value_multiple', 'type' => Controls_Manager::TEXTAREA, 'tab' => 'visibility', 'label' => __('Multiple Values', 'dynamic-content-for-elementor'), 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab', 'description' => __('One value per line. Type them in the same order of the selected fields', 'dynamic-content-for-elementor'), 'condition' => array('dce_field_visibility_mode!' => 'visible', 'dce_field_visibility_multiple' => 'yes'));
            $control_data['fields']['dce_field_visibility_multiple_logic'] = array('name' => 'dce_field_visibility_multiple_logic', 'type' => Controls_Manager::SELECT, 'label' => __('Logic operator', 'dynamic-content-for-elementor'), 'options' => ['&&' => 'AND', '||' => 'OR'], 'condition' => array('dce_field_visibility_mode!' => 'visible', 'dce_field_visibility_multiple' => 'yes'), 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab');
            $control_data['fields']['dce_field_visibility_render'] = array('label' => __('Disable only', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'tab' => 'visibility', 'tabs_wrapper' => 'form_fields_tabs', 'inner_tab' => 'form_fields_visibility_tab', 'name' => 'dce_field_visibility_render', 'condition' => array('dce_field_visibility_mode!' => 'visible', 'field_type!' => 'step'));
        }
        if ($element->get_name() == 'form' && $control_id == 'button_css_id') {
            $element->add_control('dce_field_visibility_mode', ['label' => __('Display mode', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['visible' => ['title' => __('Always Visible', 'dynamic-content-for-elementor'), 'icon' => 'eicon-check'], 'hidden' => ['title' => __('Always Hidden', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-square-o'], 'show' => ['title' => __('Show if', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-eye'], 'hide' => ['title' => __('Hide if', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-eye-slash']], 'toggle' => \false, 'default' => 'visible', 'separator' => 'before']);
            $element->add_control('dce_field_visibility_multiple', ['type' => Controls_Manager::CHOOSE, 'label' => __('Multiple conditions', 'dynamic-content-for-elementor'), 'options' => ['single' => ['title' => __('Single', 'dynamic-content-for-elementor'), 'icon' => 'eicon-cog'], 'yes' => ['title' => __('Multiple', 'dynamic-content-for-elementor'), 'icon' => 'eicon-cogs']], 'default' => 'single', 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'])]);
            $element->add_control('dce_field_visibility_field', ['type' => Controls_Manager::TEXT, 'label' => __('Field ID', 'dynamic-content-for-elementor'), 'placeholder' => __('name', 'dynamic-content-for-elementor'), 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'], 'dce_field_visibility_multiple' => ['', 'single', null])]);
            $element->add_control('dce_field_visibility_field_multiple', ['label' => __('Field IDs', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'placeholder' => __('name,message', 'dynamic-content-for-elementor'), 'description' => __('Separate each field ID it with a comma', 'dynamic-content-for-elementor'), 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'], 'dce_field_visibility_multiple' => 'yes')]);
            $element->add_control('dce_field_visibility_operator', ['label' => __('Operator', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SELECT, 'options' => Helper::get_string_comparison(), 'default' => 'empty', 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'])]);
            $element->add_control('dce_field_visibility_value', ['type' => Controls_Manager::TEXT, 'label' => __('Value', 'dynamic-content-for-elementor'), 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'], 'dce_field_visibility_multiple' => ['', 'single', null], 'dce_field_visibility_operator' => array('equal_to', 'not_equal', 'gt', 'lt', 'ge', 'le', 'not_contain', 'contain', 'is_checked', 'not_checked'))]);
            $element->add_control('dce_field_visibility_value_multiple', ['type' => Controls_Manager::TEXTAREA, 'label' => __('Multiple Values', 'dynamic-content-for-elementor'), 'description' => __('One value per line, write them in same order of Fields IDs', 'dynamic-content-for-elementor'), 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'], 'dce_field_visibility_multiple' => 'yes')]);
            $element->add_control('dce_field_visibility_multiple_logic', ['type' => Controls_Manager::CHOOSE, 'label' => __('Logic operator', 'dynamic-content-for-elementor'), 'options' => ['&&' => ['title' => __('AND', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle'], '||' => ['title' => __('OR', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle-o']], 'default' => '&&', 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'], 'dce_field_visibility_multiple' => 'yes')]);
            $element->add_control('dce_field_visibility_render', ['label' => __('Disable only', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'condition' => array('dce_field_visibility_mode!' => ['visible', 'hidden'])]);
        }
        return $control_data;
    }
}
