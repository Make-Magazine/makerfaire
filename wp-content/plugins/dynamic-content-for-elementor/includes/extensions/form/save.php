    ...
    private function dce_elementor_form_save($record, $settings = null, $ajax_handler = null)
    {
        ...
        if ($settings['dce_form_save_type'] == 'user') {
            if (!get_current_user_id()) {
                if ('yes' === $settings['dce_form_save_type_user_login']) {
                    global $user;
