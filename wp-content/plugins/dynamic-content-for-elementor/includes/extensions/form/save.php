...
class DCE_Extension_Form_Save extends \ElementorPro\Modules\Forms\Classes\Action_Base
{
    ...
    public function register_settings_section($widget)
    {
        ...
        if (\Elementor\Plugin::$instance->editor->is_edit_mode() && !current_user_can('administrator')) {
            $widget->add_control('admin_notice', ['name' => 'admin_notice', 'type' => Controls_Manager::RAW_HTML, 'raw' => '<div class="elementor-panel-alert elementor-panel-alert-warning">' . __('You will need administrator capabilities to edit this action.', 'dynamic-content-for-elementor') . '</div>']);
            $widget->end_controls_section();
            return;
        }
        $widget->add_control('dce_form_save_type', ['label' => __('Save fields as', 'dynamic-content-for-elementor'), 'type' => \Elementor\Controls_Manager::CHOOSE, 'options' => ['post' => ['title' => __('Post', 'dynamic-content-for-elementor'), 'icon' => 'eicon-post-content'], 'user' => ['title' => __('User', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-user'], 'term' => ['title' => __('Term', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-tag'], 'option' => ['title' => __('Option', 'dynamic-content-for-elementor'), 'icon' => 'eicon-check']], 'default' => 'post', 'toggle' => \false, 'label_block' => 'false']);
        if (!get_option('users_can_register')) {
            $widget->add_control('user_can_register_notice', ['type' => Controls_Manager::RAW_HTML, 'raw' => '<div class="elementor-panel-alert elementor-panel-alert-warning">' . __('User registration is currently disabled. Please enable it in WordPress Settings - General - Membership.', 'dynamic-content-for-elementor') . '</div>', 'condition' => ['dce_form_save_type' => 'user']]);
        }
        ...
        $widget->add_control('dce_form_save_metas', ['label' => __('Form fields to save as meta', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'placeholder' => 'name,message', 'description' => __('Type here the Field IDs with a comma. The Field ID must have the same name of the meta. Leave it empty to save all fields.', 'dynamic-content-for-elementor'), 'label_block' => 'true']);
        ...
        $widget->add_control('dce_form_save_type_post_content', ['label' => __('Post Content', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'default' => '[field id="message"]', 'description' => __('Can use static text, field shortcode, tokens or mixed', 'dynamic-content-for-elementor'), 'condition' => ['dce_form_save_type' => 'post'], 'label_block' => 'true']);
        ...
        $widget->add_control('dce_form_save_type_post_status', ['label' => __('Post Status', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['publish' => ['title' => __('Publish', 'dynamic-content-for-elementor'), 'icon' => 'eicon-post-content'], 'private' => ['title' => __('Private', 'dynamic-content-for-elementor'), 'icon' => 'eicon-lock'], 'draft' => ['title' => __('Draft', 'dynamic-content-for-elementor'), 'icon' => 'eicon-pencil']], 'default' => 'publish', 'toggle' => \false, 'label_block' => 'true', 'condition' => ['dce_form_save_type' => 'post', 'dce_form_save_override' => '']]);
        ...
        $widget->add_control('dce_form_save_type_user_error_stop', ['label' => __('Stop Actions on Error', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER, 'description' => __('Stop Dynamic.ooo - Dynamic Content for Elementor form actions (it doesn’t stop Elementor actions) on Error,  username or email are not valid', 'dynamic-content-for-elementor'), 'condition' => ['dce_form_save_type' => 'user', 'dce_form_save_override' => '']]);
        $widget->add_control('dce_form_save_type_term_name', ['label' => __('Term Name', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'default' => 'Term [field id="name"]', 'description' => __('Can use static text, field Shortcode, Token or mixed. Leave it empty for random values', 'dynamic-content-for-elementor'), 'condition' => ['dce_form_save_type' => 'term'], 'label_block' => 'true', 'separator' => 'before']);
        $widget->add_control('dce_form_save_type_term_description', ['label' => __('Term Description', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::TEXT, 'default' => '[field id="message"]', 'description' => __('Can use static text, field Shortcode, Token or mixed', 'dynamic-content-for-elementor'), 'condition' => ['dce_form_save_type' => 'term'], 'label_block' => 'true']);
