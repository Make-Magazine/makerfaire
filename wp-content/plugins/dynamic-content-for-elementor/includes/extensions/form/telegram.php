...
class DCE_Extension_Form_Telegram extends \ElementorPro\Modules\Forms\Classes\Action_Base
{
    ...
    public function register_settings_section($widget)
    {
        ...
        $repeater_fields->add_control('dce_form_telegram_condition_status', ['label' => __('Condition Status', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'options' => ['empty' => ['title' => __('Empty', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-circle-o'], 'valued' => ['title' => __('Valued', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-dot-circle-o'], 'lt' => ['title' => __('Less than', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-angle-left'], 'gt' => ['title' => __('Greater than', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-angle-right'], 'equal' => ['title' => __('Equal to', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-check-circle-o '], 'contain' => ['title' => __('Contain', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-inbox ']], 'default' => 'valued', 'toggle' => \false, 'label_block' => \true, 'condition' => ['dce_form_telegram_condition_field!' => '']]);
