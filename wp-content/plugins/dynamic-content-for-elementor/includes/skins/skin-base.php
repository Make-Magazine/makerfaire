...
abstract class Skin_Base extends Elementor_Skin_Base
{
    ...
    {
        $this->parent->add_render_attribute('dynposts_' . $id, ['class' => ['dce-item', 'dce-' . $item_id, 'elementor-repeater-item-' . $id]]);
    ...
    {
        $custommeta_items = $this->parent->get_settings_for_display('custommeta_items');
        if (\is_array($custommeta_items) && !empty($custommeta_items[0]['metafield_key'])) {
            ...
            foreach ($custommeta_items as $key => $item) {
                ...
                if (isset($meta_html)) {
                    $this->parent->add_render_attribute($attribute_custommeta_item, ['class' => ['dce-meta-item', 'dce-meta-' . $_id, 'dce-meta-' . $metafield_type, 'elementor-repeater-item-' . $item['_id']]]);
