    ...
    protected function render_post()
    {
        ...
        foreach ($post_items as $key => $item) {
            ...
            ?>
				...
				<?php 
            if ($this->get_instance_value('timeline_use_description') && $_id == 'item_content') {
                ?>
				<div class="dce-timeline__description item_content"><?php 
            ...
            ?>
				...
				<?php 
            if ($this->get_instance_value('timeline_use_date') && $_id == 'item_date') {
                ?>
