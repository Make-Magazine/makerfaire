...
class Skin_Gridtofullscreen3d extends \DynamicContentForElementor\Includes\Skins\Skin_Grid
{
    ...
    public function register_additional_gridtofullscreen3d_controls()
    {
        ...
        $this->add_control('gridtofullscreen3d_effects', ['label' => __('Grid-to-Fullscreen Effect', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SELECT, 'default' => 'effect1', 'options' => ['effect1' => __('Effect', 'dynamic-content-for-elementor') . ' 1', 'effect2' => __('Effect', 'dynamic-content-for-elementor') . ' 2', 'effect3' => __('Effect', 'dynamic-content-for-elementor') . ' 3', 'effect4' => __('Effect', 'dynamic-content-for-elementor') . ' 4', 'effect5' => __('Effect', 'dynamic-content-for-elementor') . ' 5', 'effect6' => __('Effect', 'dynamic-content-for-elementor') . ' 6', 'custom_effect' => __('Custom effect', 'dynamic-content-for-elementor')], 'frontend_available' => \true, 'render_type' => 'template']);
