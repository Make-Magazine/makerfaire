...
use DynamicOOOS\Symfony\Component\DomCrawler\Image;
class ImageTest extends TestCase
{
    ...
    {
        return [['/foo.png', 'http://localhost/bar/foo/', 'http://localhost/foo.png'], ['foo.png', 'http://localhost/bar/foo/', 'http://localhost/bar/foo/foo.png']];
    }
}
