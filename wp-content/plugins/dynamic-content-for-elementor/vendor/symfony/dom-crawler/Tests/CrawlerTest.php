...
, 'UTF-8');
    ...
    public function testEq()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->eq() returns a new instance of a crawler');
    ...
    public function testSlice()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler->slice(), '->slice() returns a new instance of a crawler');
    ...
    public function testReduce()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $nodes, '->reduce() returns a new instance of a crawler');
    ...
    public function testAttr()
    {
        ...
        try {
            ...
            $this->assertTrue(\true, '->attr() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    ...
    public function testNodeName()
    {
        ...
        try {
            ...
            $this->assertTrue(\true, '->nodeName() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    ...
    public function testFilterXPath()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->filterXPath() returns a new instance of a crawler');
    ...
    public function testFilter()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->filter() returns a new instance of a crawler');
    ...
    public function testSelectLink()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->selectLink() returns a new instance of a crawler');
    ...
    public function testSelectImage()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->selectImage() returns a new instance of a crawler');
    ...
    public function testSelectButton()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->selectButton() returns a new instance of a crawler');
...
HTML;
    ...
    public function testLink()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Link', $crawler->link(), '->link() returns a Link instance');
        ...
        try {
            ...
            $this->assertTrue(\true, '->link() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    ...
    public function testImage()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Image', $crawler->image(), '->image() returns an Image instance');
        try {
            $this->createTestCrawler()->filterXPath('//ol')->image();
            $this->fail('->image() throws an \\InvalidArgumentException if the node list is empty');
        } catch (\InvalidArgumentException $e) {
            $this->assertTrue(\true, '->image() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
...
HTML;
    ...
    public function testLinks()
    {
        ...
        $links = $crawler->links();
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Link', $links[0], '->links() returns an array of Link instances');
    ...
    public function testImages()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Image', $images[0], '->images() returns an array of Image instances');
        $this->assertEquals([], $this->createTestCrawler()->filterXPath('//ol')->links(), '->links() returns an empty array if the node selection is empty');
    }
    public function testForm()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Form', $crawler->form(), '->form() returns a Form instance');
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Form', $crawler2->form(), '->form() returns a Form instance');
        ...
        try {
            ...
            $this->assertTrue(\true, '->form() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    ...
    public function testLast()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->last() returns a new instance of a crawler');
    ...
    public function testFirst()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->first() returns a new instance of a crawler');
    ...
    public function testSiblings()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->siblings() returns a new instance of a crawler');
        ...
        try {
            ...
            $this->assertTrue(\true, '->siblings() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    public function testNextAll()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->nextAll() returns a new instance of a crawler');
        ...
        try {
            ...
            $this->assertTrue(\true, '->nextAll() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    public function testPreviousAll()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->previousAll() returns a new instance of a crawler');
        ...
        try {
            ...
            $this->assertTrue(\true, '->previousAll() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    public function testChildren()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->children() returns a new instance of a crawler');
        ...
        try {
            ...
            $this->assertTrue(\true, '->children() throws an \\InvalidArgumentException if the node list is empty');
        }
        try {
            $crawler = new Crawler('<p></p>');
            $crawler->filter('p')->children();
            $this->assertTrue(\true, '->children() does not trigger a notice if the node has no children');
        } catch (\DynamicOOOS\PHPUnit\Framework\Error\Notice $e) {
    ...
    public function testParents()
    {
        ...
        $this->assertInstanceOf('DynamicOOOS\\Symfony\\Component\\DomCrawler\\Crawler', $crawler, '->parents() returns a new instance of a crawler');
        ...
        try {
            ...
            $this->assertTrue(\true, '->parents() throws an \\InvalidArgumentException if the node list is empty');
        }
    }
    /**
    ...
    {
        return [['http://base.com', 'link', 'http://base.com/link'], ['//base.com', 'link', 'https://base.com/link', 'https://domain.com', '<base> tag can use a schema-less URL'], ['path/', 'link', 'https://domain.com/path/link', 'https://domain.com', '<base> tag can set a path'], ['http://base.com', '#', 'http://base.com#', 'http://domain.com/path/link', '<base> tag does work with links to an anchor'], ['http://base.com', '', 'http://base.com', 'http://domain.com/path/link', '<base> tag does work with empty links']];
    }
    /**
    ...
    {
        return [['https://base.com/', 'link/', 'https://base.com/link/', 'https://base.com/link/', '<base> tag does work with a path and relative form action'], ['/basepath', '/registration', 'http://domain.com/registration', 'http://domain.com/registration', '<base> tag does work with a path and form action'], ['/basepath', '', 'http://domain.com/registration', 'http://domain.com/registration', '<base> tag does work with a path and empty form action'], ['http://base.com/', '/registration', 'http://base.com/registration', 'http://domain.com/registration', '<base> tag does work with a URL and form action'], ['http://base.com', '', 'http://domain.com/path/form', 'http://domain.com/path/form', '<base> tag does work with a URL and an empty form action'], ['http://base.com/path', '/registration', 'http://base.com/registration', 'http://domain.com/path/form', '<base> tag does work with a URL and form action']];
    }
