...
if (!\class_exists('DynamicOOOS\\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser
    {
        ...
        {
            // whitelisted chars
            if (\function_exists('DynamicOOOS\\user_sanitize')) {
                // bbPress native
        ...
        {
            if (\function_exists('DynamicOOOS\\encodeit')) {
                // bbPress native
        ...
        {
            if (\function_exists('DynamicOOOS\\decodeit')) {
                // bbPress native
