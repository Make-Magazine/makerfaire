...
if (!\class_exists('DynamicOOOS\\Puc_v4p11_DebugBar_Panel', \false) && \class_exists('DynamicOOOS\\Debug_Bar_Panel', \false)) {
    class Puc_v4p11_DebugBar_Panel extends Debug_Bar_Panel
    {
        ...
        private function displayStatus()
        {
            ...
            $checkNowButton = '';
            if (\function_exists('DynamicOOOS\\get_submit_button')) {
