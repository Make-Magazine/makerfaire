...
if (!\class_exists('DynamicOOOS\\Puc_v4p11_UpdateChecker', \false)) {
    abstract class Puc_v4p11_UpdateChecker
    {
        ...
        public function loadTextDomain()
        {
            ...
            $locale = apply_filters('plugin_locale', is_admin() && \function_exists('DynamicOOOS\\get_user_locale') ? get_user_locale() : get_locale(), $domain);
        ...
        protected function fixSupportedWordpressVersion(Puc_v4p11_Metadata $update = null)
        {
            ...
            if (\function_exists('DynamicOOOS\\get_core_updates')) {
        ...
        {
            if (!\function_exists('DynamicOOOS\\wp_get_installed_translations')) {
                return array();
            }
        ...
        {
            if (\class_exists('DynamicOOOS\\Debug_Bar', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
