	...
	<section id="faireInfo">
		<div class="faire-video">
			...
			if($faire_video && filter_var($faire_video, FILTER_VALIDATE_URL) && is_valid_video($faire_video)) {
				...
				<?php } elseif(stripos($faire_video,'tiktok.com') !== false) {
