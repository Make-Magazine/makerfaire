...
<body <?php body_class('activity bp-user my-activity just-me buddypress page page-id-0 page-parent page-template-default network-colors wpb-js-composer js-comp-ver-4.12 vc_responsive js'); ?>>
