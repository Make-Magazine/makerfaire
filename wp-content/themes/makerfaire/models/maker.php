...
class maker {
  ...
  //get the resource messaging for an entry - layout defined in form settings
  public function get_resource_msg($form, $entry) {
    $response = '';
    $exhibit  = FALSE;
  ...
  public function get_table_data() {
    ...
    foreach ($results as $row) {
      ...
      if (
        $form['form_type'] != 'Other'           && $form['form_type'] != 'Payment' &&
