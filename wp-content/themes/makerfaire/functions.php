...
$output = '<div class="row filter-container mmakers">'
        ...
        .'<div class="post" style="padding-top:12px; background-color:black">'
        . '<video width="375" height="230" poster="http://www.makerfaire.com/wp-content/themes/makerfaire/images/how_preview.png"  controls>'
        . ' <source src="http://makerfaire.com/wp-content/uploads/2016/03/How-To-Get-to-Maker-Faire-1.mp4"  type="video/mp4">'
        . ' Your browser does not support the video tag.'
        . '</video>'
        . '<div class="text-box" style="top:0;bottom:inherit"><span class="section">How will YOU get to Maker Faire?</span></div>'
        . '</div>'
...
add_filter( 'gform_pre_render_55', 'populate_html' );
add_filter( 'gform_pre_render_56', 'populate_html' );
add_filter( 'gform_pre_render_57', 'populate_html' );
add_filter( 'gform_pre_render_58', 'populate_html' );
add_filter( 'gform_pre_render_59', 'populate_html' );
