<?php
   ...
   function do_social_block($args) {
      ...
      $content .= '     <a href="https://twitter.com/makerfaire"><i aria-hidden="true" class="fab fa-twitter"></i></a>';
      $content .= '     <a href="https://www.instagram.com/makerfaire/"><i aria-hidden="true" class="fab fa-instagram"></i></a>';
      $content .= '     <a href="https://www.facebook.com/makerfaire"><i class="fab fa-facebook" aria-hidden="true"></i></a></h4>';
