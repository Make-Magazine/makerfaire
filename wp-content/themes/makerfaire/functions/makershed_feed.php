...
function makershedOutput($collection = MAKERSHED_DEFAULT_COLLECTION, $amount = "4") {
    ...
    if(!empty($makershedProducts)) {
        ...
        $makershedOutput .= '<h3>Learn, Create, and Share with <i>Make:</i></h3>';
            ...
            $makershedOutput .= '<div class="card">
                                    <a href="https://subscribe.makezine.com/loading.do?omedasite=Make_subscribe&PK=M3GCT015&utm_source=makerfaire.com&utm_medium=cross-site&utm_campaign=makershed_related&utm_content=https://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] .'" class="related-makershed-item" target="_blank">
