...
(function(){
  ...
  function setCountdownHTML() {
    var faireDate = jQuery('#faireDate').val();

    var mfbaDate = new Date(faireDate);
    var now = new Date();
...
;//!!
//!! js/src/jquery-carousel-plugin.js
/*
...
;//!!
//!! js/src/jquery-open-close-plugin.js
/*
...
//!! js/src/open-ext-links-new-tab.js
...
;//!!
//!! js/src/youtube-modal-shortcode.js
/*
