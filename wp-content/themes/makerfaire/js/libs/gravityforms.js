jQuery( document ).ready(function() {
  ...
  if (jQuery('#input_43_340').length) {
    if(jQuery('#input_43_340').val()!=''){
      var state = jQuery('#input_43_340').val();
      var input_43_341 = jQuery('#input_43_341').val();
      var input_43_342 = jQuery('#input_43_342').val();
      var input_43_343 = jQuery('#input_43_343').val();
      popStoreSel(state);
      //select the previous selected store
      jQuery('#input_43_341 option[value="'+input_43_341+'"]').attr("selected", "selected");
      jQuery('#input_43_342 option[value="'+input_43_342+'"]').attr("selected", "selected");
      jQuery('#input_43_343 option[value="'+input_43_343+'"]').attr("selected", "selected");
    }
  }
...
function popStoreSel(state){
  ...
  for(var i = 0; i < locationjson.length; i++) {
    ...
    for (var x = 0; x < arrayLength; x++) {
      ...
      jQuery('#input_43_341').append('<option value="'+stateData[x]+'">'+stateData[x].substr(6)+'</option>');
      jQuery('#input_43_342').append('<option value="'+stateData[x]+'">'+stateData[x].substr(6)+'</option>');
      jQuery('#input_43_343').append('<option value="'+stateData[x]+'">'+stateData[x].substr(6)+'</option>');
    }
  }
}
