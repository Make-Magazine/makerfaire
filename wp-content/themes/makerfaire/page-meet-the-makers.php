      ...
      <div class="row">
         ...
         <div class="col-md-4">
            <ul class="nav nav-pills">
               <li class="active">
                  <button type="button" ng-click="makerSearch.flag='Featured Maker'" class="btn btn-default">Featured</button>
               </li>
               <li>
                  <button type="button" ng-click="makerSearch.flag=''" class="btn btn-default">All</button>
               </li>   
            </ul>            
         </div>
         <div class="col-md-4">
