...
class ICS {
  ...
  function buildCal($events) {
    $return = array();
    $return = $this->addCalHead();
    //array_merge($return,$rows);
    foreach($events as $event){
      $data = $this->addEvent($event);
      $return = array_merge($return,$data);
    }
    $foot = $this->addCalFoot();
    $return = array_merge($return,$foot);
    //var_dump($return);
    return implode("\r\n", $return);
  }
  private function addCalHead() {
