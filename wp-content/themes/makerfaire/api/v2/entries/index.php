...
*/
  ...
  //$return = array('makers' =>$entries, 'layout'=>$tabArr ,'form_fields'=>$field_array);
  return $return;
}
    ...
    //$entry['rmt'] = entryResources($entry, FALSE);
      switch ($fieldID) {
          ...
          case 'notes_table':    
              $type  = 'html';
              $label = '';
              $value = '<table cellspacing="0" class="gf-entry-summary">
              <tr>
                <td>
                  Enter Email: <input type="email" placeholder="example@make.co" name="otherEmail" size="40" />
                </td>
