        ...
        <?php if($exhibit_video && is_valid_video($exhibit_video)) { ?>
            <div class="project-video">            
                <?php                 		
                    ...
                    <?php } else if(str_contains($exhibit_video, "tiktok.com")) { 
